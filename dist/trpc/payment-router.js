...
exports.PaymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.protectedProcedure.input(zod_1.z.object({
        productIds: zod_1.z.array(zod_1.z.string()),
    })).mutation(function (_a) {
        var ctx = _a.ctx, input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filteredProducts, line_items, order, stripeSession, error_1;
    ...
    pollOrderStatus: trpc_1.protectedProcedure
