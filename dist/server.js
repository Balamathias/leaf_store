...
var next_app_1 = require("./app/next-app");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                app.use(function (req, res) { return (0, next_app_1.nextHandler)(req, res); });
                next_app_1.nextApp.prepare().then(function () {
                    payload.logger.info("Nextjs Started");
                });
                app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        payload.logger.info("NextJs public URL: ".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                        return [2 /*return*/];
                    });
                }); });
                return [2 /*return*/];
