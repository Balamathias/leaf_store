...
var isAdminOrOwnerOfImage = function () { return function (_a) {
    var req = _a.req;
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!req.user || !(referer === null || referer === void 0 ? void 0 : referer.includes('sell')))
                                return [2 /*return*/, true];
                            return [4 /*yield*/, isAdminOrOwnerOfImage()({ req: req })];
                        case 1: return [2 /*return*/, _b.sent()];
                    }
                });
            });
        },
        delete: isAdminOrOwnerOfImage(),
        update: isAdminOrOwnerOfImage()
    },
    upload: {
        staticURL: '/media',
        staticDir: 'media',
