...
var ReceiptEmail = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Your MStore Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/email-sent.png"), width: '100', height: '100', alt: 'MStore' })),
                ...
                products.map(function (product) {
                    ...
                    return (React.createElement(components_1.Section, { key: product.id },
                        React.createElement(components_1.Column, { style: { width: '64px' } }, typeof image !== 'string' &&
                            (image === null || image === void 0 ? void 0 : image.url) ? (React.createElement(components_1.Img, { src: image.url, width: '64', height: '64', alt: 'Product Image', style: productIcon })) : null),
