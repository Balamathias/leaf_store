  ...
  return (
    <MaxWrapper className=''>
          ...
          <div className='lg:max-w-lg lg:self-end'>
                ...
                <li key={breadcrumb.href}>
                  <div className='flex items-center text-sm'>
                    <Link
                      ...
                      className='font-medium text-sm text-muted-foreground hover:text-secondary-foreground'>
                      {breadcrumb.name}
                    </Link>
                    {i !== BREADCRUMBS.length - 1 ? (
                      <svg
                        ...
                        fill='currentColor'
                        aria-hidden='true'
                        className='ml-2 h-5 w-5 flex-shrink-0 text-secondary'>
            ...
            <section className='mt-4'>
              <div className='flex items-center'>
                ...
                <div className='ml-4 border-l text-muted-foreground border-secondary pl-4'>
                  {label}
                </div>
              </div>
      ...
      <ProductReel
        ...
        title={`Similar Product for ${label}`}
