...
const ThankYouPage = async ({
  ...
  if (orderUserId !== user?.id) {
    return redirect(
      `/sign-in?origin=success?orderId=${order.id}`
    )
  }
  ...
  return (
    <main className='relative lg:min-h-full pt-10'>
      <div className='hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12'>
        <Image
          fill
          src='/checkout_success.png'
                        ...
                        <div className='relative h-24 w-24'>
                          ...
                          image?.url ? (
                            <Image
                              ...
                              className='flex-none rounded-md bg-background object-cover object-center'
                            />
                          ) : null}
                        </div>
